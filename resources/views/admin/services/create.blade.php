...
<div class="admin-page-head">
    <div>
        ...
        <p class="admin-page-subtitle">
            Fill in the details to create a new dental service
        </p>
    </div>
</div>
            ...
            <div class="form-card-body">
                ...
                <div class="field-group">
                    ...
                    <select name="category"
                        ...
                        <option value="routine" {{ old('category') == 'routine' ? 'selected' : '' }}>Routine Care</option>
                        ...
                        <option value="special" {{ old('category') == 'special' ? 'selected' : '' }}>Special Care</option>
                    </select>
                ...
                <div class="field-group">
                    ...
                    <select name="card_style"
                        ...
                        <option value="normal" {{ old('card_style', 'normal') == 'normal' ? 'selected' : '' }}>Normal</option>
                        <option value="featured" {{ old('card_style') == 'featured' ? 'selected' : '' }}>Featured</option>
                        <option value="urgent" {{ old('card_style') == 'urgent' ? 'selected' : '' }}>Urgent</option>
                    </select>
            ...
            <div class="form-card-body">
                ...
                <div class="field-group">
                    ...
                    <textarea name="overview_description_one"
                              ...
                              rows="5"
                              class="field-input {{ $errors->has('overview_description_one') ? 'error' : '' }}">{{ old('overview_description_one') }}</textarea>
                </div>
                ...
                <div class="field-group">
                    ...
                    <textarea name="overview_description_two"
                              ...
                              rows="5"
                              class="field-input {{ $errors->has('overview_description_two') ? 'error' : '' }}">{{ old('overview_description_two') }}</textarea>
                </div>
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text"
                               ...
                               value="{{ old('overview_card_subtitle') }}"
        ...
        <div class="form-card">
            ...
            <div class="form-card-body">
                ...
                <div class="repeat-wrapper" data-repeat="overview_points">
                    ...
                    @php $overviewPoints = old('overview_points', ['']); @endphp

                    @foreach($overviewPoints as $index => $item)
                ...
                <div class="repeat-wrapper" data-repeat="symptoms">
                    ...
                    @php $symptoms = old('symptoms', ['']); @endphp
                ...
                <div class="repeat-wrapper" data-repeat="process_steps">
                    ...
                    @php $processSteps = old('process_steps', ['']); @endphp
                ...
                <div class="repeat-wrapper" data-repeat="aftercare_points">
                    ...
                    @php $aftercarePoints = old('aftercare_points', ['']); @endphp

                    @foreach($aftercarePoints as $index => $item)
                        <div class="repeat-item">
                            <input type="text"
            ...
            <div class="form-card-body">
                ...
                <div class="field-group">
                    ...
                    <textarea name="seo_description"
                              ...
                              class="field-input {{ $errors->has('seo_description') ? 'error' : '' }}">{{ old('seo_description') }}</textarea>
                </div>
