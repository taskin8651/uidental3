...
@section('page-title', 'Add Before / After Result')
...
<div class="admin-page-head">
    <div>
        ...
        <h2 class="admin-page-title">Add Before / After Result</h2>

        <p class="admin-page-subtitle">
            Fill in the details to create a new treatment result
        </p>
    </div>
</div>

<form method="POST"
      action="{{ route('admin.before-after-results.store') }}"
        ...
        <div class="form-card">
            <div class="form-card-header">
                ...
                <div>
                    ...
                    <p class="form-card-subtitle">Upload both treatment result images</p>
                </div>
            </div>
