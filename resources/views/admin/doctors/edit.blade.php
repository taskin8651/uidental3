...
<div class="admin-page-head">
    <div>
        ...
        <h2 class="admin-page-title">Edit Doctor</h2>
            ...
            <div class="form-card-body">
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text" name="badge_text" id="badge_text"
                               value="{{ old('badge_text', $doctor->badge_text) }}"
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text" name="heading" id="heading"
                               value="{{ old('heading', $doctor->heading) }}"
                ...
                <div class="field-group">
                    ...
                    <textarea name="description" id="description" rows="5"
                              ...
                              class="field-input {{ $errors->has('description') ? 'error' : '' }}">{{ old('description', $doctor->description) }}</textarea>
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text" name="doctor_title" id="doctor_title"
                               value="{{ old('doctor_title', $doctor->doctor_title) }}"
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text" name="doctor_subtitle" id="doctor_subtitle"
                               value="{{ old('doctor_subtitle', $doctor->doctor_subtitle) }}"
        ...
        <div class="form-card">
            ...
            <div class="form-card-body">
                ...
                <div class="field-group">
                    ...
                    @else
                        <p class="field-hint"><i class="fas fa-info-circle"></i> Upload only if you want to replace image</p>
                    @endif
                </div>
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text" name="image_alt" id="image_alt"
                               value="{{ old('image_alt', $doctor->image_alt) }}"
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text" name="rating_text" id="rating_text"
                               value="{{ old('rating_text', $doctor->rating_text) }}"
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text" name="review_text" id="review_text"
                               value="{{ old('review_text', $doctor->review_text) }}"
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text" name="timing_days" id="timing_days"
                               value="{{ old('timing_days', $doctor->timing_days) }}"
                               placeholder="Mon-Sat"
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text" name="timing_hours" id="timing_hours"
                               value="{{ old('timing_hours', $doctor->timing_hours) }}"
        ...
        <div class="form-card">
            ...
            <div class="form-card-body">
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text" name="qualification_label" id="qualification_label"
                               value="{{ old('qualification_label', $doctor->qualification_label) }}"
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text" name="qualification_value" id="qualification_value"
                               value="{{ old('qualification_value', $doctor->qualification_value) }}"
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text" name="specialization_label" id="specialization_label"
                               value="{{ old('specialization_label', $doctor->specialization_label) }}"
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text" name="specialization_value" id="specialization_value"
                               value="{{ old('specialization_value', $doctor->specialization_value) }}"
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text" name="consultation_label" id="consultation_label"
                               value="{{ old('consultation_label', $doctor->consultation_label) }}"
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text" name="consultation_value" id="consultation_value"
                               value="{{ old('consultation_value', $doctor->consultation_value) }}"
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text" name="care_focus_label" id="care_focus_label"
                               value="{{ old('care_focus_label', $doctor->care_focus_label) }}"
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text" name="care_focus_value" id="care_focus_value"
                               value="{{ old('care_focus_value', $doctor->care_focus_value) }}"
                ...
                <div class="field-group">
                    ...
                    <label class="role-checkbox-item {{ old('status', $doctor->status) ? 'checked' : '' }}" style="max-width:190px;">
